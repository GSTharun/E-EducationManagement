...
public class StudentController {
    ...
    @PostMapping("/create")
    public String createStudent(@ModelAttribute("student") Student student, BindingResult bindingResult, @RequestParam("courseId") Long courseId) {
    ...
    @PostMapping("/edit/{id}")
    public String editStudent(@PathVariable Long id, @ModelAttribute("student") Student updatedStudent, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return "student/edit";
        }
        Student student = studentRepository.findById(id).orElse(null);
